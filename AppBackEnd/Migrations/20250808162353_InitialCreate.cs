    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Medicina geral", "Clínico Geral" },
                    { 2, true, "Especialidade do coração", "Cardiologia" },
                    { 3, true, "Especialidade dos ossos e articulações", "Ortopedia" },
                    { 4, true, "Especialidade infantil", "Pediatria" },
                    { 5, true, "Especialidade feminina", "Ginecologia" }
                });
